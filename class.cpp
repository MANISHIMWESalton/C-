...
//  Write a C++program to calculate simple interest, use meaningful variable names and
// comments
...
int time;
float SI;
cout<<"Enter prencipal,rate and time: "<<endl;
cin>>prencipal >>rate >> time;

SI = (prencipal * rate * time)/100;
